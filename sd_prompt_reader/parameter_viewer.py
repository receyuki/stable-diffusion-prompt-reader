...
class ParameterViewer:
    def __init__(self, parent, status_bar):
        ...
        self.setting_sampler_frame = CTkFrame(self.setting_box_parameter, fg_color="transparent")
        ...
        self.setting_seed_frame = CTkFrame(self.setting_box_parameter, fg_color="transparent")
        ...
        self.setting_steps_frame = CTkFrame(self.setting_box_parameter, fg_color="transparent")
        ...
        self.setting_size_frame = CTkFrame(self.setting_box_parameter, fg_color="transparent")
