...
from sd_prompt_reader.button import STkButton, SortMode, ViewMode, PromptMode
...
class PromptViewer:
    def __init__(self, parent, status_bar, default_text):
        ...
        self.prompt_box_g = self.PromptBox(self, self.prompt_frame_sdxl, True)
        ...
        self.prompt_box_g.textbox.pack(fill="both", expand=True)
    ...
    def display(self, prompt):
        if isinstance(prompt, str):
            ...
            self.prompt_box_g.prompt = prompt
    ...
    class PromptBox:
        def __init__(self, prompt_viewer, frame, is_sdxl=None):
            ...
            #                              mode=SortMode.OFF)
            # self.button_sort.pack(side="left", padx=5)
