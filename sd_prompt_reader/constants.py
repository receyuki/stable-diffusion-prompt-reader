...
COPY_FILE_L = (Path(RESOURCE_DIR, "content_copy_24.png"), Path(RESOURCE_DIR, "content_copy_24_alpha.png"))
COPY_FILE_S = (Path(RESOURCE_DIR, "content_copy_20.png"), Path(RESOURCE_DIR, "content_copy_20_alpha.png"))
CLEAR_FILE = (Path(RESOURCE_DIR, "mop_24.png"), Path(RESOURCE_DIR, "mop_24_alpha.png"))
DOCUMENT_FILE = (Path(RESOURCE_DIR, "description_24.png"), Path(RESOURCE_DIR, "description_24_alpha.png"))
EXPAND_FILE = (Path(RESOURCE_DIR, "expand_more_24.png"), Path(RESOURCE_DIR, "expand_more_24_alpha.png"))
EDIT_FILE = (Path(RESOURCE_DIR, "edit_24.png"), Path(RESOURCE_DIR, "edit_24_alpha.png"))
EDIT_OFF_FILE = (Path(RESOURCE_DIR, "edit_off_24.png"), Path(RESOURCE_DIR, "edit_off_24_alpha.png"))
